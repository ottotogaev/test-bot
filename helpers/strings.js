...
const english = {
  tutorialMessages: {
    initialMessage: 'Ushbu bot qanday ishlashini bilmayapsizmi? Xavotir olmang - biz sizni qamrab oldik. Faqat quyidagi o\'quv qo\'llanmalaridan birini sinab ko\'ring. \n\n Agar siz frilanserlarni qidirsangiz, iltimos, "Mijozlar uchun qo\'llanma" ni tanlang; agar siz ish izlayotgan freelancer bo\'lsangiz, iltimos, "Freelancer tutorial" -ni tanlang.',
    // initialMessage:
    ...
    initialFreelancerMessage: '@Teleworkuz_bot-ning asosiy maqsadi potentsial mijozlarga ularning ehtiyojlariga mos keladigan barcha mavjud frilanserlar ro\'yxatini taqdim etishdir. Mijoz ish joyini yaratgandan so\'ng, biz freelancerlarning ro\'yxatini ularning biosi va reytinglari bilan yuboramiz. Keyin mijoz bioslarni o\'qiydi va qaysi freelancerlarga dastlabki ish takliflarini olishi kerakligini hal qiladi. Agar mijoz sizni ish talablariga javob berishiga qaror qilsa, sizga ish ta\'rifi, ushbu matndan keyingi tugmachalar kabi tugmachalar va agar kerak bo\'lsa, mijozning reytingi keladi. \n\n Agar siz "Hisobot" yoki "Not manfaatdor "variantlari, siz ushbu ish uchun mavjud bo\'lgan frilanserlar ro\'yxatidan yo\'qolasiz. "Manfaatdor" ni tanlasangiz, mijoz ushbu ish taklifiga qiziqishingiz haqida xabar beradi va sizni qiziqqan nomzodlar ro\'yxatiga qo\'shadi. "Qiziqarli" va "Qiziq emas" variantlari mavjud bo\'lsa, tanlovdan so\'ng fikringizni o\'zgartirishingiz mumkin. Davom eting, ushbu ish taklifiga javob bering! \n\n ⭐️⭐️⭐️⭐️ (10) \n [Veb backend] \n Bizga veb-xizmatni yaratish kerak. Bizning jamoamizda allaqachon mobil ishlab chiqaruvchi va frontend dasturchi mavjud. Biz bu keyingi katta narsa bo\'lishiga ishonamiz. Faqat uchta so\'z: "Facebook mushuklar uchun" - bozor hajmi va bizdagi imkoniyatlarni tasavvur qiling. Bizning mukammal nomzodimiz C #, PHP va JavaScript-ni yaxshi biladi.',
    ...
    clientTutorialFinishRate:
      'Woohoo! Looks like everything is done. Let\'s say that your job is completed — the only thing left is to rate the experience with your freelancer. This rating will be visible to the other clients on @Teleworkuz_bot. Note that after you select "Report" button our fellow moderators will start investigation to dispense the justice.\n\nGo ahead and rate the freelancer!',
    clientTutorialFinishRateReport:
      'Well, this happens sometimes. You have reported @borodutch for some nasty reason. After you select the "Report" option our fellow moderators start investigation to dispense the justice.\n\nHowever, let\'s assume that the "Rate" button was pressed. The only thing left is rating the experience with the freelancer. This rating will be visible to the other clients on @Teleworkuz_bot. Go ahead and rate the freelancer!',
    clientTutorialEnd:
  ...
  helpMessage:
    'If you want to learn more about this bot, please go to telework.uz. \n\n If you have any questions, concerns or just found a bug, please read our support channel @teleworkasia. \n\n If you would like to learn how this bot works, please click the relevant button below. \n\n Thank you a lot for your support!',
  becameBusyMessage:
  ...
  mainMenuOptions: {
    findJobs: '👤 Shaxsiy kabinet',
    findContractors: '⛑ Frilanserlarni topish',
    help: '❔ Help',
    chooseLanguage: '📣 Choose language',
  },
  clientMenuOptions: {
    postNewJob: '🔨 Yangi ish joyini yaratish',
    myJobs: '🛠 Yaratilgan ishlar',
    back: '🔙 Orqaga',
  },
  changeTo: 'Change to: ',
  back: '🔙 Orqaga',
  freelanceMenuOptions: {
    editBio: '🖊 Edit bio',
    addBio: '🖊 O\'z haqingizda: ',
    editCategories: '📌 Kategoriyalarni tahrirlash',
    addCategories: '📌 Kategoriyalar qo\'shing',
    editHourlyRate: '💲 Soatlik narxni tahrirlash',
    addHourlyRate: '💲 Soatlik narxni qo\'shish',
    back: '🔙 Orqaga',
    busy: '⚒ Band',
    available: '✅ Mavjud',
  ...
  hourlyRateAllRatesOption: 'Barcha soatlik tariflar',
  selectedCategory: '✅ ',
  selectedHourlyRate: '✅ ',
  selectedLanguage: '✅ ',
  categoryLeft: '<',
